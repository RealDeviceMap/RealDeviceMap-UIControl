...
# Full path of UIControl workspace (ie. "/Source/RDM/_Base/RealDeviceMap-UIControl.xcworkspace")
WORKSPACE_PATH=""

# Desired location of where you want your DerivedData folders to go (ie. "/Source/RDM/DerivedData")
DERIVEDDATA_PATH=""
