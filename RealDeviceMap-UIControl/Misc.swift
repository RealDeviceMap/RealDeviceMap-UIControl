...
extension XCTestCase {
    ...
    func isStartup(screenshot: XCUIScreenshot?=nil) -> Bool {
        ...
        if screenshotComp.rgbAtLocation(pos: deviceConfig.startup_NewCautionSign, min: (red: 1.00, green: 0.97, blue: 0.60), max: (red: 1.00, green: 1.00, blue: 0.65)) && screenshotComp.rgbAtLocation(pos: deviceConfig.startup_NewButton, min: (red: 0.28, green: 0.79, blue: 0.62), max: (red: 0.33, green: 0.85, blue: 0.68)) {
            Log.startup("Should be clearing Caution Sign new startup prompt")
            deviceConfig.startup_NewButton.toXCUICoordinate(app: app).tap()
            return true
        } else if screenshotComp.rgbAtLocation(pos: deviceConfig.startup_OldOkButton, min: (red: 0.42, green: 0.82, blue: 0.60), max: (red: 0.47, green: 0.86, blue: 0.63)) && screenshotComp.rgbAtLocation(pos: deviceConfig.startup_OldCornerTest, min: (red: 0.15, green: 0.41, blue: 0.45), max: (red: 0.19, green: 0.46, blue: 0.49)) {
            Log.startup("Should be Clearing the 2 line long, old style startup prompt")
            deviceConfig.startup_OldOkButton.toXCUICoordinate(app: app).tap()
            return true
        } else if screenshotComp.rgbAtLocation(pos: deviceConfig.startup_OldOkButton, min: (red: 0.42, green: 0.82, blue: 0.60), max: (red: 0.47, green: 0.86, blue: 0.63)) && screenshotComp.rgbAtLocation(pos: deviceConfig.startup_OldCornerTest, min: (red: 0.99, green: 0.99, blue: 0.99), max: (red: 1.01, green: 1.01, blue: 1.01)) {
