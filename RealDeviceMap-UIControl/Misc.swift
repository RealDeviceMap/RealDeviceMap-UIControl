...
extension XCTestCase {
    ...
    func freeScreen(app: XCUIApplication, comparePassenger: (x: Int, y: Int), compareWeather: (x: Int, y: Int), coordWeather1: XCUICoordinate, coordWeather2: XCUICoordinate, coordPassenger: XCUICoordinate) {
    ...
    func logOut(app: XCUIApplication, closeMenuButton: XCUICoordinate, settingsButton: XCUICoordinate, dragStart: XCUICoordinate, dragEnd: XCUICoordinate, logoutButton: XCUICoordinate, logoutConfirmButton: XCUICoordinate, compareStartLoggedOut:  (x: Int, y: Int)) -> Bool {
